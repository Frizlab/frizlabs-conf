...
# Nothing should be done here because this file is read by ALL zsh shells, including script ones.
# Usually this file is used to set ZDOTDIR when the zsh config files are stored in a non-standard location.
