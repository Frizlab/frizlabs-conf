...
# We do not install Homebrew for Python 3.8 and 3.7 because we do not need them!
...
#start_task "install homebrew for python2.7";      catchout RES  install_homebrew "$HOMEBREW_PYTHON27_USER_DIR"; log_task_from_res "$RES"
#start_task "install python@2.7.17"; catchout RES  install_brew_package "$HOMEBREW_PYTHON27_USER_DIR" "Frizlab/Perso/python@2.7.17" "opt/python@2.7.17/bin/python2" "--formula"; log_task_from_res "$RES"
