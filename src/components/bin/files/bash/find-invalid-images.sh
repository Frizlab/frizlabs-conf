...
# If the second argument is present and set to 0,
# the script outputs the invalid images separated by a "\0" instead of "\n"
# in order to be ready to be inputed to xargs -0
