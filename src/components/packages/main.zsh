...
# Then the x86 Homebrew install if on macOS ARM
test "$HOST_OS:$HOST_ARCH" = Darwin:arm64 && { CURRENT_TASK_NAME="install homebrew x86"; catchout res  install_homebrew "$HOMEBREW_X86_DIR"; log_task_from_res "$res" } || true
