 ...
 * The “correct” way would be to use the undocumented
 * `_CFPreferencesCopyApplicationMap` function that the `defaults` tool uses.
 * See https://gist.github.com/jessepeterson/a46562565affbe87789e and
 * https://stackoverflow.com/a/20719428 */
